...
Motor LFD (LFD_Port,MOTOR_GEARSET_18,false,MOTOR_ENCODER_DEGREES),
      ...
      BLI (Bottom_Intake_Left_Port,MOTOR_GEARSET_6,false,MOTOR_ENCODER_DEGREES),
      BRI (Bottom_Intake_Right_Port,MOTOR_GEARSET_6,true,MOTOR_ENCODER_DEGREES),
      TI (Top_Intake_Port,MOTOR_GEARSET_6,false,MOTOR_ENCODER_DEGREES),
      Arm (Arm_Port,MOTOR_GEARSET_18,true,MOTOR_ENCODER_DEGREES);
